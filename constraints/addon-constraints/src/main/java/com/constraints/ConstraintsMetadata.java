 ...
 * @since 1.1.0
 */
public class ConstraintsMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = ConstraintsMetadata.class.getName();
    ...
    public ConstraintsMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
